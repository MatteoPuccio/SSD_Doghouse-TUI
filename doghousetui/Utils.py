...
INVALID_PASSWORD_ERROR="Invalid password (at least 8 characters between letters, numbers and @, #, !)"
...
DOG_GREATER_BIRTH_DATE_INPUT = '\tmaximum birth year(yyyy) [OPTIONAL]: '
